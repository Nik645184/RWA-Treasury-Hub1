...
import { USDCMultichainBalance } from '@/components/portfolio/USDCMultichainBalance';
...
const Portfolio = () => {
  ...
  return (
    <PageLayout title="Treasury Portfolio Management">
      {/* Portfolio Summary */}
      ...
      {/* Tabbed Content */}
      <Tabs defaultValue="usdc" className="space-y-6">
        <TabsList>
